...
- **Trap catalog**: <!-- catalog-stats:userFacing -->34<!-- /catalog-stats:userFacing --> documented iOS silent-failure modes plus <!-- catalog-stats:maintenance -->7<!-- /catalog-stats:maintenance --> catalog-maintenance gates ([`data/traps.json`](./data/traps.json)), rendered as [`AGENTS.md`](./AGENTS.md) and [`CLAUDE.md`](./CLAUDE.md). <!-- catalog-stats:prGated -->24<!-- /catalog-stats:prGated --> rules are enforced at PR time by `pnpm surface:check`; the rest surface as typed runtime errors or advisory notes.
