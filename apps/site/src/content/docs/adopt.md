...
The published JSON Schema at `https://unpkg.com/@mobile-surfaces/surface-contracts@9.0/schema.json` is generated from the same Zod source. Backends that prefer Ajv, jsonschema, or a Valibot-via-Standard-Schema interop can validate without depending on Zod at runtime.
