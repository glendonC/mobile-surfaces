...
Cut the linked release train at 2.0.0. The major bump is driven by `create-mobile-surfaces`; the runtime packages (`surface-contracts`, `design-tokens`, `live-activity`, `push`) align with the train.
