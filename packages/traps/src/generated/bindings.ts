...
>([
    ...
    [
      ...
      errorClasses: ["InvalidSnapshotError"] as const,
      },
    ],
    [
      "MS009",
    ...
    [
      ...
      errorClasses: ["PayloadTooLargeError"] as const,
      },
    ],
    [
      "MS012",
    ...
    [
      ...
      errorClasses: ["BadDeviceTokenError", "TokenEnvironmentMismatchError"] as const,
      },
    ],
    [
      "MS015",
      ...
      errorClasses: ["TooManyRequestsError"] as const,
      },
    ],
    [
      "MS016",
    ...
    [
      ...
      siblings: ["MS035"] as const,
      errorClasses: ["TopicDisallowedError", "MalformedApnsConfigError"] as const,
      },
    ],
    [
      "MS019",
    ...
    [
      ...
      errorClasses: ["UnregisteredError"] as const,
      },
    ],
    [
      "MS021",
    ...
    [
      ...
      errorClasses: ["MissingApnsConfigError"] as const,
      },
    ],
    [
      "MS029",
    ...
    [
      ...
      errorClasses: ["ExpiredProviderTokenError", "ForbiddenError", "InvalidProviderTokenError"] as const,
      },
    ],
    [
      "MS031",
      ...
      errorClasses: ["BadChannelIdError", "ChannelNotRegisteredError", "MissingChannelIdError"] as const,
      },
    ],
    [
      "MS032",
      ...
      errorClasses: ["BadDateError", "BadExpirationDateError"] as const,
      },
    ],
    [
      "MS033",
    ...
    [
      ...
      errorClasses: ["FeatureNotEnabledError"] as const,
      },
    ],
    [
      "MS035",
      ...
      siblings: ["MS018"] as const,
      errorClasses: ["MissingTopicError"] as const,
      },
    ],
    [
      "MS036",
    ...
    [
      ...
      errorClasses: ["InvalidContentStateError"] as const,
      },
    ],
    [
      "MS039",
