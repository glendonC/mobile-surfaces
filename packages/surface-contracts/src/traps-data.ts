...
export const traps: readonly TrapEntry[] = [
  ...
  {
    "id": "MS005",
    "title": "Validator regex parity between rename and CLI scaffolder",
    "severity": "error",
    "detection": "static",
    "tags": [
      "contract",
    ...
    "summary": "scripts/rename-starter.mjs and the create-mobile-surfaces CLI must share identical projectSlug, scheme, and bundleId regexes.",
